...
tests/, tests_integration/, tests_system/ 세 테스트 루트가 각자 동일한 11개 협력 객체
(IU-0002~0004, IU-0006~0008, IU-0010~0013, IU-0005) 기본 생성 코드를 반복해서 pylint
...
def buildOrchestratorKwargs(**overrides):
    """!
    @brief SafetyKernelOrchestrator의 11개 협력 객체 기본값(전부 실물)을 kwargs 딕셔너리로
